...
# Rollback Script Welcome — v1.1.0 → v1.0.0
# Uso: ./rollback-welcome.sh [--backup-db]
# Rollback a tag v1.0.0-welcome-baseline
...
BACKUP_DIR="./backups"
BASELINE_TAG="v1.0.0-welcome-baseline"

echo "=========================================="
echo "Rollback Welcome v1.1.0 → v1.0.0"
...
SERVICE_NAME="adaria-welcome"
if systemctl is-active --quiet "$SERVICE_NAME" 2>/dev/null; then
    sudo systemctl stop "$SERVICE_NAME" 2>/dev/null
    echo "✓ Servicio detenido"
fi

# Resetear a v1.0.0-welcome-baseline
